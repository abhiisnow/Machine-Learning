...
model.add(LSTM(128, return_sequences=True, dropout=0.2, recurrent_dropout=0.15))
...
model.save(wd + '\\models\\model_file(128).h5') 

#%% use model
model = load_model(wd + '\\models\\model_file(128).h5') 
